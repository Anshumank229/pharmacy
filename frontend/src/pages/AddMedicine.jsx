...
const AddMedicine = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post("/medicines", { ...form, imageUrl, price: Number(form.price), stock: Number(form.stock) || 0 });
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                {imagePreview ? (
                  ...
                  <div className="w-24 h-24 bg-gray-100 rounded-xl border-2 border-dashed border-gray-300 flex items-center justify-center text-gray-400 text-xs text-center">
                    No image
                  </div>
                )}
                <div className="flex-1">
                  ...
                  />
                  <p className="text-xs text-gray-400 mt-1">Or enter a URL below</p>
                  <input
                    type="url"
                    name="imageUrl"
                    value={form.imageUrl}
            ...
            <div className="flex items-center gap-3 p-4 bg-yellow-50 rounded-xl border border-yellow-200">
              ...
              <label htmlFor="requiresPrescription" className="text-sm font-medium text-gray-700">
                🩺 Requires Prescription — customers must upload a prescription to purchase this item
              </label>
            </div>
